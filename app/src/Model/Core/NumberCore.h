...
namespace StockCharts
{
	...
	{
	public:
		static const Number			EmptyValue;
		static const std::string	EmptyValueStr;

	public:
		NumberCore();
		NumberCore(const Number val);
		NumberCore(int cnt, const Number val = EmptyValue);
		...
		bool	isEmpty() const;
		int		size() const;
		void	resize(int cnt, const Number val = EmptyValue);
		void	clear();
