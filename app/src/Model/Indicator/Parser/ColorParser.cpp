...
std::tuple<bool, ExpColor> ColorParser::process(const std::string& name)
{
	bool ok = false;
	ExpColor expColor;
...
std::tuple<bool, ExpColor> ColorParser::colorType(const std::string& name)
{
...
std::tuple<bool, ExpColor> ColorParser::lineThick(const std::string& name)
{
...
std::tuple<bool, ExpColor> ColorParser::colorString(const std::string& name)
{
